(new Image(1,1)).src=("https://consent.trustarc.com/log".replace("http:","https:"))+"?domain=twilio.com&country=us&state=&behavior=implied&c="+(((1+Math.random())*65536)|0).toString(16).substring(1);
